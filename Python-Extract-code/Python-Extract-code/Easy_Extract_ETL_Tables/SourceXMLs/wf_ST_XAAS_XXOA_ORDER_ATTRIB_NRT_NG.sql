ETL Name:	wf_ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG.xml


Session 1: 	s_m_ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG
Mapping 1: 	m_ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG


Source1 Name : SQ_ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG
...
SELECT 
  ...
  CXOA.ATTRIBUTION_DETAILS      ,
    ...
    WHEN A.NEXT_DAY_SRC_COMMIT_TIME IS NOT NULL AND A.CNT <> 0 THEN B.PROCESS_END_DTM
         ...
         WHERE A.JOB_STREAM_ID = 'wf_ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG'
         AND B.SS_CD='XAAS')
...
Target1 Name : ST_XAAS_XXOA_ORDER_ATTRIB_NRT1_NG


Pre SQL : 
DELETE FROM $$NRTSTGDB.ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG ALL;


Post SQL : 
COLLECT STATS $$NRTSTGDB.ST_XAAS_XXOA_ORDER_ATTRIB_NRT_NG;