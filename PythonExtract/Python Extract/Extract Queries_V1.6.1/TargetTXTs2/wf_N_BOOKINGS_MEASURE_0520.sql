...
AND NBM.BKGS_MEASURE_TRANS_TYPE_CODE = 'ERP'
AND NBM.DV_SALES_ORDER_LINE_KEY IN ( SELECT DV_SALES_ORDER_LINE_KEY FROM $$WORKDB.W_BOOKINGS_MEASURE WHERE BKGS_MEASURE_TRANS_TYPE_CODE = 'ERP' GROUP BY 1)
)NBM
