...
CREATE MULTISET VOLATILE TABLE ST_OPL_XXGCO_RTR_ATTRIB_CV_SET_CV 
 ...
 QUALIFY ROW_NUMBER() OVER(PARTITION BY RTR_ATTRIBUTION_ID, OA_ATTRIBUTION_ID, SS_CD,
 (CASE WHEN POS_TRANSACTION_ID_INT<0 THEN ST.TRX_ID ELSE POS_TRANSACTION_ID_INT END) ORDER BY EDW_CREATE_DTM DESC ) = 1   /*US498075-ADDED TRX_ID IN GRAIN */ 
...
DELETE FROM $$STGDB.WI_OPL_XXGCO_RTR_ATTRIB_CV WK 
 ...
 AND (CASE WHEN WK.POS_TRANSACTION_ID_INT<0 THEN WK.SK_ERP_BKGS_TRX_ID ELSE WK.POS_TRANSACTION_ID_INT END)=(CASE WHEN EX.POS_TRANSACTION_ID_INT<0 THEN EX.TRX_ID ELSE EX.POS_TRANSACTION_ID_INT END) /* US498075-ADDED TRX_ID AS THE GRAIN IS CHANGED */) ;
