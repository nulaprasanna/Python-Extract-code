...
SQL Query : 
SELECT
 SMC_FINAL.AR_TRX_LINE_KEY,
  SMC_FINAL.DV_ENTERPRISE_INV_SKU_ID,
...
AND DRVD.DV_AR_TRX_LINE_KEY NOT IN (SEL AR_TRX_LINE_KEY FROM $$STGDB.WI_AR_NAPLD_SLS_MOTION_ATTRIB GROUP BY 1)
GROUP BY 1,2,3,4,5
