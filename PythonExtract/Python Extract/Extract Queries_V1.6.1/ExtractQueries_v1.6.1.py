...
def extractQueries(sourceFolder="SourceXMLs", targetFolder="TargetTXTs2", targetFileExt=".sql"):
    ...
    for inputFile in filesList:
        ...
        SQnExpMappingDict = {}
        SQnExpConnections = soup.find_all("connector", attrs={"frominstancetype": ["Source Qualifier"],
        ...
        ExpnTgtMappingDict = {}
        ExpnTgtConnections = soup.find_all("connector", attrs={"frominstancetype": ["Expression"],
        ...
        for eachTag in ExpnTgtConnections:
            if eachTag['toinstance'] not in ExpnTgtMappingDict.keys():
                ...
                ExpnTgtMappingDict[eachTag['toinstance']] = SQnExpMappingDict[
                    eachTag['frominstance']]  # to map Source Qualifiers with their respective target definitions
        # print("ExpnTgtMappingDict : ",ExpnTgtMappingDict)

        Tgt2SrcMappingDict = {}
        Tgt2SrcMappingDict.update(ExpnTgtMappingDict)
        SQnTgtConnections = soup.find_all("connector", attrs={"frominstancetype": ["Source Qualifier"],
                                                              "toinstancetype": ["Target Definition"]})
